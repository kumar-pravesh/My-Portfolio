...
const CaseStudiesPage = () => {
  ...
  useEffect(() => {
    document.title = "Case Studies — Pravesh Kumar Portfolio";
    let isMounted = true;
    publicApi
      .getCaseStudies()
      .then((data) => {
  ...
  const filtered = caseStudies.filter((cs) => {
    const matchesSearch =
      ...
      cs.reference_id?.toLowerCase().includes(search.toLowerCase());

    const matchesCategory =
      activeCategory === "All" ||
      cs.industry?.toLowerCase().includes(activeCategory.toLowerCase());
  ...
  return (
    <div className="pt-20 sm:pt-24 pb-20 px-[5%] lg:px-[9%] min-h-screen max-w-7xl mx-auto space-y-8 sm:space-y-10">
      ...
      <div className="relative text-center max-w-3xl mx-auto space-y-4 pt-4">
        ...
        >
          <FileText size={12} /> Engineering Dossiers & Audits
        </motion.div>
        ...
        >
          In-depth technical analysis, system design challenges, microservices
          implementation, and production-tested benchmark results.
        </motion.p>
        ...
        >
          ...
          <div className="relative group">
            ...
            <input
              type="text"
              placeholder="Search by case study title, client, industry, or Ref ID..."
              value={search}
